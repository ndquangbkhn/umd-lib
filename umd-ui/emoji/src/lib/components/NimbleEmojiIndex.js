import { classCallCheck, createClass } from "@lib/common/class";
import { getSanitizedData, getData, intersect } from "@lib/components/EmojiUtils";
...
var NimbleEmojiIndex =
    ...
    function () {
        function NimbleEmojiIndex(data, set) {
            classCallCheck(this, NimbleEmojiIndex);
        ...
        (0, createClass)(NimbleEmojiIndex, [{
            key: "buildIndex",
                ...
                var _loop = function _loop(emoji) {
                    ...
                    if (skin_variations) {
                        ...
                        for (var skinTone = 1; skinTone <= 6; skinTone++) {
                            _this.emojis[id][skinTone] = (0, getSanitizedData)({
                                id: id,
                                skin: skinTone
                            }, skinTone, _this.set, _this.data);
                        }
                    } else {
                        _this.emojis[id] = (0, getSanitizedData)(id, null, _this.set, _this.data);
                    }
            ...
            value: function addCustomToPool(custom, pool) {
                ...
                custom.forEach(function (emoji) {
                    ...
                    if (emojiId && !pool[emojiId]) {
                        pool[emojiId] = (0, getData)(emoji, null, null, _this3.data);
                        _this3.emojis[emojiId] = (0, getSanitizedData)(emoji, null, null, _this3.data);
                    }
                });
            ...
            value: function search(value) {
                ...
                var skinTone = _store.getStorage('skin') || 1;
